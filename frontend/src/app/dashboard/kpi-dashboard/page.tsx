...
import { CategoryPieChart } from '../overview/_components/category-pie-chart';
import { CohortHistoryTable } from '../overview/_components/cohort-history-table';
import { OrganizationStatsTable } from '../overview/_components/organization-stats-table';

export const metadata = { title: 'Dashboard: 사업 진척률·KPI' };
...
export default async function OverviewPage() {
  ...
  return (
    <PageContainer
      pageTitle='사업 진척률·KPI'
      pageDescription={`사업 전체 실적 · ${generated} 집계`}
      pageHeaderAction={
