/**
 * AI 챔피언 블루 3회차 사전 세팅 체크리스트 시드.
 * 항목 3개: Zoom 설치 / Zoom 테스트(분기) / Python 설치.
 *
 * usage:
 *   bun run scripts/seed-blue3-pretraining.ts          # dry-run
 *   bun run scripts/seed-blue3-pretraining.ts --apply  # 실행
 */
...
const COHORT_NAME = 'AI 챔피언 블루 3회차';
