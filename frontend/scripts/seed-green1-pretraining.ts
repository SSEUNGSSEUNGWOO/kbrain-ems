/**
 * AI 챔피언 그린 1회차 사전 세팅 체크리스트 시드.
 * 항목: Zoom 설치/테스트(분기) + ChatGPT·Claude·Gemini·NotebookLM·공공데이터포털·Python·Lovable·v0.
 *
 * usage:
 *   bun run scripts/seed-green1-pretraining.ts          # dry-run
 *   bun run scripts/seed-green1-pretraining.ts --apply  # 실행
 */
...
const COHORT_NAME = 'AI 챔피언 그린 1회차';
